...
@Composable fun MonoTheme(mode: MonoTheme, content: @Composable () -> Unit) { MaterialTheme(colorScheme = if (mode == MonoTheme.LIGHT) light else dark, typography = Typography(), content = content) }
